...
public class StatisticsController {
    ...
    public ResponseEntity<?> getSurveyOverview(@PathVariable("surveyId") Long surveyId) {
        try {
    ...
    public ResponseEntity<?> getSurveyTimeline(@PathVariable("surveyId") Long surveyId) {
        try {
    ...
    public ResponseEntity<?> getSurveyQuestionCounts(@PathVariable("surveyId") Long surveyId) {
        try {
    ...
    public ResponseEntity<?> getSurveyCharts(@PathVariable("surveyId") Long surveyId) {
        try {
    ...
    public ResponseEntity<?> getSurveyTextAnalysis(@PathVariable("surveyId") Long surveyId) {
        try {
    ...
    public ResponseEntity<?> getSurveySentimentAnalysis(@PathVariable("surveyId") Long surveyId) {
        try {
    ...
    public ResponseEntity<?> exportSurveyReportPDF(@PathVariable("surveyId") Long surveyId) {
        try {
